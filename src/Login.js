        ...
        <div className="mainLogin">
            <div className="LoginBox">
                ...
                <div className="UserInfo">
                    <div className="email" >
                        <input className="Inputfield" type="text" value={email} placeholder="Email Address"
                        onChange={(e)=>handelEmail(e)}/>
                        {emailValidate ? (<div></div>):(<div className="Validation">*Please enter valid EmailID</div>)}
                    </div>
                    <div className="password">
                        ...
                        {passwordValidate? (<div></div>):(<div className="Validation">*Please enter atleast 5 digits password</div>)}
                    </div>
                </div>
                ...
                <div className="SignUp">
                    ...
                    <a className="SignUpText" href="/signup">SignUp</a>
                </div>
            </div>
